<template>
  <div class="align-middle">
    <div
      class="w-full h-screen bg-auto bg-right-bottom"
      :style="{
        backgroundImage: 'url(' + require('@/assets/strefaotwarta.jpg') + ')'
      }"
      style="object-fit: contain; background-repeat: no-repeat; background-size: cover;"
    >
      <div
        class="absolute w-full h-screen bg-green-500"
        style="z-index: 2; opacity: 0.08;"
      ></div>
      <div class="w-full h-screen flex flex-col justify-center">
        <!--        <div-->
        <!--          class="max-w-2xl xl:pl-6 xl:pr-6 ml-4 mr-4 rounded overflow-hidden shadow-2xl self-center bg-white"-->
        <!--          style="z-index: 3; box-shadow: rgba(0, 0, 0, 0.9) 0 25px 50px 10px;"-->
        <!--        >-->
        <!--          <div>-->
        <!--            <div class="px-6 py-4">-->
        <!--              <div class="font-bold text-xl text-center mb-4 lg:pb-4">-->
        <!--                Herbaciarnia-->
        <!--              </div>-->
        <!--              <p class="xl:text-lg text-justify lg:pb-4">-->
        <!--                Szeroki wybór wybitnych herbat, a także pysznych kaw i świetnej-->
        <!--                shishy to oczywisty punkt wyjścia dobrej herbaciarni. Jednak-->
        <!--                tworząc to wyjątkowe miejsce, postaraliśmy się także o możliwość-->
        <!--                odpoczynku, zrelaksowania się i oddania się dobrej zabawie.-->
        <!--              </p>-->
        <!--            </div>-->
        <!--            <div class="px-6 pb-4 text-center">-->
        <!--                      <a-->
        <!--                        href="#"-->
        <!--                        class="inline-block bookman w-56 bg-green-700 text-xl px-4 py-4 leading-none border rounded text-white border-white hover:border-green-700 hover:text-green-700 hover:bg-white ml-auto mr-auto transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"-->
        <!--                        >Zarezerwuj teraz</a-->
        <!--                      >-->
        <!--            </div>-->
        <!--          </div>-->
        <!--        </div>-->
        <div
          class="max-w-xl xl:pl-6 xl:pr-6 ml-4 mr-4 self-center"
          style="z-index: 3;"
        >
          <div>
            <svg
              class="w-full h-auto max-h-screen fill-current text-white mt-24"
              ...
              id="svg8"
              version="1.1"
              viewBox="0 0 245.8533 148.53207"
              height="148.53207mm"
              width="245.8533mm"
            >
              <defs id="defs2">
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3735">
                  <path d="M 0,595.28 H 841.89 V 0 H 0 Z" id="path3733" />
                </clipPath>
                ...
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3839">
                  <path d="m 257.984,308.437 v 0 z" id="path3837" />
                </clipPath>
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3851">
                  <path d="m 264.234,311.45 v 0 z" id="path3849" />
                </clipPath>
                ...
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3879">
                  <path
                    d="M 240.218,368.999 H 372.392 V 80.6229 H 240.218 Z"
                    id="path3877"
                  />
                </clipPath>
                ...
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3911">
                  <path d="M 0,595.28 H 841.89 V 0 H 0 Z" id="path3909" />
                </clipPath>
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3919">
                  <path
                    d="M 87.27,467.134 H 307.261 V 46.0979 H 87.27 Z"
                    id="path3917"
                  />
                </clipPath>
                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath3975">
                  <path d="M 0,595.28 H 841.89 V 0 H 0 Z" id="path3973" />
                </clipPath>
              </defs>
              ...
              <g transform="translate(71.521884,-42.817295)" id="layer1">
                <g
                  id="g3721"
                  transform="matrix(0.35277777,0,0,-0.35277777,-102.3088,207.61168)"
                >
                  <g id="g3905">
                    <g id="g3907" clip-path="url(#clipPath3911)">
                      <g id="g3913">
                        <g id="g3915" />
                        <g id="g3967">
                          <g clip-path="url(#clipPath3919)" id="g3965">
                            <g
                              transform="translate(296.0096,284.8037)"
                              id="g3923"
                            >
                              <path
                            ...
                            <g
                              transform="translate(255.5496,251.2637)"
                              id="g3927"
                            >
                              <path
                            ...
                            <g
                              transform="translate(269.1796,124.3137)"
                              id="g3931"
                            >
                              <path
                            ...
                            <g
                              transform="translate(244.0096,159.9737)"
                              id="g3935"
                            >
                              <path
                            ...
                            <g
                              transform="translate(181.8396,220.0837)"
                              id="g3939"
                            >
                              <path
                            ...
                            <g
                              transform="translate(232.2196,293.6637)"
                              id="g3943"
                            >
                              <path
                            ...
                            <g
                              transform="translate(193.3196,263.1637)"
                              id="g3947"
                            >
                              <path
                            ...
                            <g
                              transform="translate(185.5296,311.8437)"
                              id="g3951"
                            >
                              <path
                            ...
                            <g
                              transform="translate(161.2196,334.0037)"
                              id="g3955"
                            >
                              <path
                            ...
                            <g
                              transform="translate(154.9096,290.9337)"
                              id="g3959"
                            >
                              <path
                            ...
                            <g
                              transform="translate(134.9596,322.2537)"
                              id="g3963"
                            >
                              <path
                  ...
                  <g id="g3969">
                    <g id="g3971" clip-path="url(#clipPath3975)">
                      <g id="g3977" transform="translate(382.2687,458.2101)">
                        <path
                      ...
                      <g id="g3981" transform="translate(577.6475,429.4728)">
                        <path
                      ...
                      <g id="g3985" transform="translate(588.1174,396.58)">
                        <path
                      ...
                      <g id="g3989" transform="translate(573.3723,372.3923)">
                        <path
                      ...
                      <g id="g3993" transform="translate(608.7517,365.0832)">
                        <path
                      ...
                      <g id="g3997" transform="translate(608.7517,365.0832)">
                        <path
                          d="m 0,0 c 0.592,-0.745 4.816,1.119 7.721,3.664 0.928,0.813 1.652,1.635 2.749,2.88 2.088,2.369 3.131,3.554 3.533,4.58 1.242,3.17 -0.947,7.98 -4.057,10.208 -4.614,3.306 -11.096,0.81 -17.275,-1.57 0,0 -12.578,-4.845 -20.024,-16.621 -1.085,-1.717 -2.104,-3.686 -1.963,-6.151 0.246,-4.298 3.848,-7.155 4.974,-7.983 0.608,-0.37 4.738,-2.956 4.58,-6.544 -0.04,-0.92 -0.369,-2.038 -2.356,-4.319 -2.801,-3.216 -6.095,-5.523 -10.6,-7.852 -0.775,-0.401 -8.597,-4.445 -9.161,-3.534 -0.365,0.588 2.468,2.957 4.057,4.275 6.585,5.466 12.604,8.607 16.053,10.383 12.765,6.572 19.228,9.893 23.209,11.604 5.102,2.193 9.077,3.902 14.832,5.759 C 23.33,1.056 28.621,2.121 28.53,2.617 28.452,3.043 24.482,2.713 21.681,2.268 18.322,1.736 15.612,0.875 13.742,0.174 10.891,-0.841 7.299,-2.176 3.185,-3.839 c -2.856,-1.154 -8.542,-3.509 -15.618,-6.893 -4.296,-2.054 -8.041,-4.045 -15.53,-8.026 -6.92,-3.679 -8.704,-4.748 -10.906,-6.37 -4.899,-3.608 -9.746,-7.177 -9.162,-11.124 0.519,-3.5 5.011,-5.28 5.235,-5.366 2.104,-0.802 4.373,-0.766 11.386,1.833 14.498,5.371 18.024,10.117 19.239,12.04 0.858,1.359 1.351,2.555 1.439,3.926 0.223,3.446 -2.216,6.27 -4.318,8.638 -3.83,4.314 -6.275,4.542 -6.544,7.067 -0.22,2.062 1.185,3.827 2.617,5.627 1.928,2.422 3.931,3.651 6.282,5.104 10.829,6.694 10.027,6.397 11.91,7.329 3.833,1.898 10.112,5.007 10.993,3.796 C 11.567,11.874 -1.135,1.429 0,0 Z"
                      ...
                      <g id="g4001" transform="translate(659.6614,362.1167)">
                        <path
                      ...
                      <g id="g4005" transform="translate(659.6614,362.1167)">
                        <path
                      ...
                      <g id="g4009" transform="translate(702.3968,372.3923)">
                        <path
                      ...
                      <g id="g4013" transform="translate(718.0273,396.58)">
                        <path
                      ...
                      <g id="g4017" transform="translate(763.8396,368.2057)">
                        <path
                      ...
                      <g id="g4021" transform="translate(629.871,402.956)">
                        <path
        ...
        >
          <div class="flex flex-col h-full">
            <div class="px-6 py-4 flex-1">
              ...
              <p>
                Szeroki wybór wybitnych herbat, a także pysznych kaw i świetnej
                shishy to oczywisty punkt wyjścia dobrej herbaciarni.
              </p>
              <br />
              <p>
                Jednak tworząc to wyjątkowe miejsce, postaraliśmy się także o
                możliwość odpoczynku, zrelaksowania się i oddania się dobrej
                zabawie.
              </p>
              <br />
              <p>
                Biorąc pod uwagę zróżnicowane upodobania odwiedzających nas
                gości, zadbaliśmy o szeroką gamę atrakcji w rozmaitych
                klimatach.
              </p>
            </div>
            <div class="px-6 py-4 text-right">
              <a
                href="#"
                class="inline-block text-lg bookman py-4 font-semibold leading-none text-green-600 hover:text-green-400 mt-4 lg:mt-0 ml-auto mr-auto"
                >Czytaj dalej</a
              >
            </div>
          </div>
        ...
        <div class="text-gray-700 bg-white px-4 py-2 shadow-2xl rounded flex">
          <div class="flex flex-col h-full">
            <div class="px-6 py-4 flex-1">
              ...
              <p>
                Zdecydowaliśmy się na 2 pokoje zagadek, jeden o niższym, a drugi
                o wyższym stopniu trudności. Co kryją tajemnicze czarne drzwi?
              </p>
              <br />
              <p>
                Wkrótce będzie można się przekonać!
              </p>
            </div>
            <div class="px-6 py-4 text-right">
              <a
